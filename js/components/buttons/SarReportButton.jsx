...
/**
 * Toggle button for sarreport. Wraps {@link #components.buttons.ToggleButton} with some defaults
 ...
 *
 */
class SarReportButton extends React.Component {
    static propTypes = {
        id: PropTypes.string,
    ...
    static defaultProps = {
        id: 'sarreport-btn',
        activeTooltip: 'sarreport.tooltipDeactivate',
        notActiveTooltip: 'sarreport.tooltipActivate',
        tooltipPlace: 'left',
    ...
    render() {
        return (
            <ToggleButton
                ...
                tooltip={
                    <Tooltip
                        id="sarreport-button-tip">
                        <Message
                            msgId={this.props.active ? this.props.activeTooltip : this.props.notActiveTooltip}/>
                    </Tooltip>
                }
            />
        );
...
module.exports = SarReportButton;
