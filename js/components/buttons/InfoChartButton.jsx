...
/**
 * Toggle button for infochart. Wraps {@link #components.buttons.ToggleButton} with some defaults
 ...
 *
 */
class InfoChartButton extends React.Component {
    static propTypes = {
        id: PropTypes.string,
...
module.exports = InfoChartButton;
